...
#import "KTJTableViewProtocoler.h"
...
@interface KTJTableViewProtocoler () <UITableViewDelegate, UITableViewDataSource>

@end
@implementation KTJTableViewProtocoler
...
- (KTJTableViewProtocoler *)ktj_protocoler {
    KTJTableViewProtocoler *protocoler = objc_getAssociatedObject(self, @selector(ktj_protocoler));
    if (protocoler) {
        return protocoler;
    }
    
    protocoler = [[KTJTableViewProtocoler alloc] init];
